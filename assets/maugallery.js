...
//     responsiveImageItem: (element) =>
//       element.prop("tagName") === "IMG" && element.addClass("img-fluid"),
//     openLightBox: (element, lightboxId) => {
//       $(`#${lightboxId}`)
//         .find(".lightboxImage")
//         .attr("src", element.attr("src"));
...
//       const activeImage = $(
//         "img.gallery-item[src='" + $(".lightboxImage").attr("src") + "']"
//       );
//       const activeTag = $(".tags-bar span.active-tag").data("images-toggle");
//       const imagesCollection =
//         $.fn.mauGallery.methods.getImagesCollection(activeTag);
